 ...
 */
export function createHttpProviderError(response: Response, baseUrl: string, provider: string, detail?: string): ProviderRequestError {
 ...
 */
export function normalizeProviderError(error: unknown, provider: string, baseUrl?: string): ProviderRequestError {
