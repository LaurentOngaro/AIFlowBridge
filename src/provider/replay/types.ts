...
export type VisionMarkerTextIgnoredReason = 'vision-not-object' | 'vision-text-not-string' | 'vision-text-empty';

export type ReasoningMarkerTextIgnoredReason = 'reasoning-not-object' | 'reasoning-text-not-string' | 'reasoning-text-empty';
