...
export async function fetchMinimaxPromptTokens(options: FetchMinimaxPromptTokensOptions): Promise<number | undefined> {
  ...
  // clear the timeout in the abort handler too, not only
