...
- [ ] FEAT10: dynamic prices and cost estimation
  ...
  - move all the models's price to a specific json file (global)
    - There is an example of file in `docs/feeds/DeepseekPrices_2026-07-12T06-00-59Z.json` (generated by a schedule task in MiniMax Agent)
  - use this data every time a model price is mentioned
    - HOW can I show the current prices in the readme file ?
