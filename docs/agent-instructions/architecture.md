...
Model id convention: the `id` field in the registry IS the upstream API id (`MiniMax-M2.7`, `mimo-v2.5-pro`, `deepseek-v4-flash`). No kebab-case alias, no id translation map.
