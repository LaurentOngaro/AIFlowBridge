...
> **Data snapshot: 2026-07-14 (AIFlowBridge 2.15.4).** Source: per-vendor pricing pages for Xiaomi MiMo V2.5 / MiniMax M3 / DeepSeek V4 Flash.
...
> **Data snapshot: 2026-07-14 (AIFlowBridge 2.15.4).** Source: bundled registry ([`resources/models.json`](../resources/models.json)) and per-vendor pricing pages.
...
> **Data snapshot: 2026-07-14 (AIFlowBridge 2.15.4).** Source: `resources/pricing.json`, hydrated from OpenRouter `/v1/models`. The bundled JSON ships with every release and is regenerated by `npm run pricing:refresh` against the live OpenRouter catalog at release time.
...
> **Data snapshot: 2026-07-14 (AIFlowBridge 2.15.4).** Source: indicative figures; the +$15-30/month range for vision-capable upstream models is a rough bracket across GPT-4o / Claude Sonnet / Gemini Pro at 50 calls/day, not a quoted number.
