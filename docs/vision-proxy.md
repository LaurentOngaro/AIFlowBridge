...
>
> **Data freshness.** Cost claims in this document (the $0 vision claim, the comparison with paid vision models) are pinned to the **2026-07-14** snapshot shipped with **AIFlowBridge 2.15.5**. The Copilot subscription policy is owned by GitHub and may change independently - verify against the current Copilot plan page before relying on the $0 claim.
